...
namespace TripleA.Infrustructure.Migrations
{
    ...
    [Migration("20240701205440_add questionIq col at notification")]
    partial class addquestionIqcolatnotification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripleA.Data.Entities.Advertisement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TripleA.Data.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TripleA.Data.Entities.Identity.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TripleA.Data.Entities.UserCon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TripleA.Data.Entities.Identity.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TripleA.Data.Entities.Question", b =>
                {
                    b.HasOne("TripleA.Data.Entities.Category", "Category")
                        .WithMany("Questions")
